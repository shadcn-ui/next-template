...
const HomeEmail = () => {
  return (
    <div
    className="flex flex-col items-center gap-6 px-4 py-10 mx-24 my-10 text-lg rounded-2xl lg:flex-row lg:gap-10 lg:items-start lg:justify-between"
    ...
    >
        ...
        <form className="flex flex-col self-stretch">
            ...
            <p className="self-start px-2 py-1 my-6 rounded-full bg-mainBlue">Submit</p>
        </form>
    </div>
  )
}
